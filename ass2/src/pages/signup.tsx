          ...
          <div className="max-w-xl lg:max-w-3xl">
            ...
            <form action="#" className="mt-8 grid grid-cols-6 gap-6" onSubmit={handleSubmit(onSubmit)}>
              <div className="col-span-6 sm:col-span-3">
                ...
                />
                <p className="text-red-600 text-[10px]">{errors.firstName && errors.firstName.message}</p>
              </div>
              ...
              <div className="col-span-6 sm:col-span-3">
                ...
                <input
                  ...
                  className="mt-1 w-full rounded-md border-gray-200 bg-white text-sm text-gray-700 shadow-sm"
                />
                <p className="text-red-600 text-[10px]">{errors.lastName && errors.lastName.message}</p>
              </div>
              ...
              <div className="col-span-6">
                ...
                <input
                  ...
                  className="mt-1 w-full rounded-md border-gray-200 bg-white text-sm text-gray-700 shadow-sm"
                />
                <p className="text-red-600 text-[10px]">{errors.email && errors.email.message}</p>
              ...
              <div className="col-span-6 sm:col-span-3">
                ...
                <input
                  ...
                  className="mt-1 w-full rounded-md border-gray-200 bg-white text-sm text-gray-700 shadow-sm"
                />
                <p className="text-red-600 text-[10px]">{errors.password && errors.password.message}</p>
